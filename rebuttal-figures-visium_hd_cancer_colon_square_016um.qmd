...
base_clusterings <- read_tsv(file.path(datadir, 
                                       "combined_domains_visium_hd_cancer_colon_square_016um.tsv"),
...
# mse <- parApply(cl, base_clusterings, 2,
#              function(u) spot_entropy(coords[,c("x","y")],u, k=10))
# stopCluster(cl)
...
set.seed(14102025)
s <- sample(ncol(base_clusterings),100,replace = FALSE)
...
save_pheatmap_pdf(ph_all, "rebuttal-visium_hd_cancer_colon_square_016um.pdf", width=13, height=9)
