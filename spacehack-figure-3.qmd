...
save_pheatmap_pdf(ph_all, "figure-3-heatmap-all-withoutlabels.pdf", 
                  width = 9, height=8)

ph_all <- pheatmap(aris_all, fontsize = 6, 
                   annotation_row = anno_row, 
                   annotation_colors = ann_colors)


save_pheatmap_pdf(ph_all, "figure-3-heatmap-all-withlabels.pdf", 
                  width = 15, height=14)
