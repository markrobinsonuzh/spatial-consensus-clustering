...
for(meth in methods) {
  ann_colors[[meth]] <- c("0" = "lightgrey", "1" = "black")
...
pdf("SuppFig-DPLFC-ARI-heatmaps-all-slices-nolabels.pdf", height = 10, width = 10)
...
# for(i in 1:2) {
  ...
  ph_this <- pheatmap(aris_this, fontsize = 6,
                      show_colnames = TRUE,
                      show_rownames = FALSE,
                      color = greens,
                      main = names(tsvs)[i])
