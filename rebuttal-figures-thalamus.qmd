...
```{r display-params}
datadir <- "data/abc_atlas_wmb_thalamus"
# name <- "fig3"
...
base_clusterings <- read_csv(file.path(datadir, 
                                       "combined_clusters_6800.csv"),
...
set.seed(14102025)
s <- sample(ncol(base_clusterings),150,replace = FALSE)
aris_all <- calc_aris(base_clusterings[,s])
...
save_pheatmap_pdf(ph_all, "rebuttal-thalamus-methodclass.pdf", width=13, height=9)
